...
{
	/// <summary>
	/// Contains details of a request to rollback (undo/cancel) an order that has been created using the <see cref="ZipPaymentFlow.Auth"/> flow.
	/// </summary>
	public class RollbackOrderRequest : ZipRequestOptionsBase
	{
		/// <summary>
